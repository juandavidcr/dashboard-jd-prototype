module.exports = function(io) {
  ...
  router.post('/upload', upload.single('file'), (req, res) => {
    try {
      ...
      const fileInfo = { filename: file.filename, originalname: file.originalname, size: file.size, type: metaType, url: `/uploads/${file.filename}` };
      // Emit event to connected clients
      try {
        io && io.emit('fileUploaded', fileInfo);
      } catch (e) {
